...
export default function AccountPage() {
  ...
  // Guardado automÃ¡tico cuando cambia la foto y hay cambios
  useEffect(() => {
    if (!dirty) return;
    if (preview === initialAvatarRef.current) return;
    // Debounce ligero para evitar mÃºltiples llamadas
        ...
        <main className="max-w-3xl mx-auto py-6 px-4 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <section className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-2">
                    {/* Entradas ocultas: galeri­a y camara (frontal) */}
                    <input
                      type="file"
                      accept="image/*"
                      ref={fileRefGallery}
              ...
              {/* Guardado automÃ¡tico; sin botÃ³n de guardar */}
            </CardContent>
          </Card>
          {cropOpen && rawImage && (
